...
def load_data(alpha2="EE", year=2016):
    ...
    load_column = f"{alpha2}_load_actual_entsoe_transparency"

    load = df_load[load_column].ffill()
    ...
    wind_cf = df_wind[alpha3][
        df_wind.index.year == year
    ]
    ...
    solar_cf = df_solar[alpha3][
        df_solar.index.year == year
    ]
